...
static void on_call_state(pjsua_call_id call_id, pjsip_event *e)
{
    ...
    qt_get_curr_callinfo(&call_info);
    CallState_C(s);
}
			     ...
			     pjsip_rx_data *rdata)
{
    ...
    printf("$$$$$$$$$$$$$$$$Call get_class_I$$$$$$$$$$$$$$$$$\n");
    IncomingCall_C(s,5,call_info.remote_info.ptr);
    //call class1.
}
...
static pj_status_t app_init(void)
{
    ...
    app_config.log_cfg.console_level=0;
     app_config.log_cfg.level=0;
     app_config.log_cfg.msg_logging=0;
...
pj_status_t pjsua_app_init(const pjsua_app_cfg_t *cfg)
{
    ...
    if (status != PJ_SUCCESS)
    {
            printf("app_init   failuer\r\n");
            return status;
    }
     printf("app_init   PJ_SUCCESS\r\n");
